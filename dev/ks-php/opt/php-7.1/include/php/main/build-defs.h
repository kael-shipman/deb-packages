...
#define CONFIGURE_COMMAND " './configure'  '--prefix=/opt/php-7.1' '--with-openssl' '--with-zlib' '--with-bz2' '--with-mysqli' '--enable-mbstring' '--enable-zip' '--enable-pcntl' '--with-curl' '--with-readline' '--enable-fpm' '--with-pdo-mysql' '--with-gettext'"
...
#define PHP_EXTENSION_DIR       "/opt/php-7.1/lib/php/extensions/no-debug-non-zts-20160303"
